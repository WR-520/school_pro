...
<%@ page import="com.edu.lingnan.dto.editProject" %>
  ...
  <div class="body-content">
    ...
    <form class="form-x" action="/editProject">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="ddl" value="<%=en.getDdl()%>" name="title" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
