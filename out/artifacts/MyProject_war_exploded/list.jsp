...
<form method="post" action="" name="listform" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 成果列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <th width="10%">更新时间</th>
        <th width="310">操作</th>
        <th> <div class="button-group"> <a class="button border-red" onclick="deleAll(<%=session.getAttribute("admin")%>);"><span class="icon-trash-o"></span>
          批量删除</a> </div></th>
      </tr>
          <%
