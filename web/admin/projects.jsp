  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="/admin/addProject.jsp"> 添加科研通知</a> </li>
...
<%--        <th><input type="checkbox" name="check" value="${project.id}"></th>--%>
        ...
        <th><c:out value="${project.ddl}"/></th>
          <th><div class="button-group"> <a class="button border-main" href="/admin/editProject.jsp?id=${project.id}"><span class="icon-edit"></span> 修改</a>
<%--        <a class="button border-red" href= "deleteNews?flag=1&id=${project.id}"> <span class="icon-trash-o"></span> 删除</a> --%>
          </div></th>
        </tr>
              </c:forEach>
